...
if (count($_POST) > 0) {
    if (validate($_POST, $data, $errors)) {
        ...
        $cs->add([
            ...
            "daily_price_huf" => $data["daily_price_huf"],
            "image" => $data["image"],
...
<body>
    ...
    <div class="form-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 justify-content-center">
                        ...
                        <input type="text" name="brand" id="brand" value="<?= htmlspecialchars($data['brand'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="model" id="model" value="<?= htmlspecialchars($data['model'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="year" id="year" value="<?= htmlspecialchars($data['year'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="transmission" id="transmission" value="<?= htmlspecialchars($data['transmission'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="fuel_type" id="fuel_type" value="<?= htmlspecialchars($data['fuel_type'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="passengers" id="passengers" value="<?= htmlspecialchars($data['passengers'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="daily_price_huf" id="daily_price_huf" value="<?= htmlspecialchars($data['daily_price_huf'] ?? '') ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="image" id="image" value="<?= htmlspecialchars($data['image'] ?? '') ?>">
        ...
        <?php if (isset($success) && $success): ?>
            <span id="success-message">Car added successfully</span>
        <?php endif; ?>
    </div>
